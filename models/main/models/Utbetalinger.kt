...
enum class StønadTypeTilleggsstønader(override val klassekode: String) : Stønadstype {
    ...
    DAGLIG_REISE_AAP("TSDRASISP1-OP"),
    DAGLIG_REISE_ETTERLATTE("TSDRASISP3-OP"),
    REISE_TIL_SAMLING_ENSLIG_FORSØRGER("TSROSASISP2-OP"),
    REISE_TIL_SAMLING_AAP("TSROSASISP3-OP"),
    REISE_TIL_SAMLING_ETTERLATTE("TSROSASISP4-OP"),

    @Deprecated("skrivefeil", ReplaceWith("REISE_OPPSTART_ENSLIG_FORSØRGER"))
    REISE_OPPSTART_ENSLIG_FORSØRGET(""),
    REISE_OPPSTART_ENSLIG_FORSØRGER("TSROAAISP2-OP"),
    REISE_OPPSTART_AAP("TSROAAISP3-OP"),
    REISE_OPPSTART_ETTERLATTE("TSROAAISP4-OP"),
    REISE_OPPSTART_TILTAK_ARBEIDSFORBEREDENDE("TSROAAFT-OP"),
    REISE_OPPSTART_TILTAK_ARBEIDSTRENING("TSROAATTILT-OP"),
    REISE_OPPSTART_TILTAK_AVKLARING("TSROAAAG-OP"),
    REISE_OPPSTART_TILTAK_ENKELTPLASS_AMO("TSROAEPAMO-OP"),
    REISE_OPPSTART_TILTAK_ENKELTPLASS_FAG_YRKE_HOYERE_UTD("TSROAEPVGSHOY-OP"),
    REISE_OPPSTART_TILTAK_GRUPPE_AMO("TSROAGRAMO-OP"),
    REISE_OPPSTART_TILTAK_GRUPPE_FAG_YRKE_HOYERE_UTD("TSROAGRVGSHOY-OP"),
    ...
    REISE_TIL_SAMLING_TILTAK_ARBEIDSFORBEREDENDE("TSROSAFT-OP"),
    REISE_TIL_SAMLING_TILTAK_ARBEIDSTRENING("TSROSATTILT-OP"),
    REISE_TIL_SAMLING_TILTAK_AVKLARING("TSROSAAGR-OP"),
    REISE_TIL_SAMLING_TILTAK_ENKELTPLASS_AMO("TSROSEPAMO-OP"),
    REISE_TIL_SAMLING_TILTAK_ENKELTPLASS_FAG_YRKE_HOYERE_UTD("TSROSEPVGSHOY-OP"),
    REISE_TIL_SAMLING_TILTAK_GRUPPE_AMO("TSROSGRAMO-OP"),
    REISE_TIL_SAMLING_TILTAK_GRUPPE_FAG_YRKE_HOYERE_UTD("TSROSVGSHOY-OP"),
    REISE_TIL_SAMLING_TILTAK_HØYERE_UTDANNING("TSROSHOYUTD-OP"),
    REISE_TIL_SAMLING_TILTAK_JOBBKLUBB("TSROSJK2009-OP"),
    REISE_TIL_SAMLING_TILTAK_OPPFØLGING("TSROSOPPFAG-OP"),
...
enum class StønadTypeValp(override val klassekode: String) : Stønadstype {
    ...
    ENKELTPLASS_ARBEIDSMARKEDSOPPLAERING_SEMESTERAVGIFT("TTOENKPAMOSEMAVG"),
    ENKELTPLASS_ARBEIDSMARKEDSOPPLAERING_SKOLEPENGER("TTOENKPAMOSKOLP"),
    ENKELTPLASS_ARBEIDSMARKEDSOPPLAERING_STUDIEREISE("TTOENKPAMOSTUDR"),

    ENKELTPLASS_FAG_OG_YRKESOPPLAERING_EKSAMENSGEBYR("TTOENKPFOYEKSGEB"),
    ENKELTPLASS_FAG_OG_YRKESOPPLAERING_INTEGRERT_BOTILBUD("TTOENKPFOYINTBT"),
    ENKELTPLASS_FAG_OG_YRKESOPPLAERING_SEMESTERAVGIFT("TTOENKPFOYSEMAVG"),
    ENKELTPLASS_FAG_OG_YRKESOPPLAERING_SKOLEPENGER("TTOENKPFOYSKOLP"),
    ENKELTPLASS_FAG_OG_YRKESOPPLAERING_STUDIEREISE("TTOENKPFOYSTUDR"),

    HOYERE_YRKESFAGLIG_UTDANNING_EKSAMENSGEBYR("TTOFAGHOYUDEKSGE"),
    HOYERE_YRKESFAGLIG_UTDANNING_INTEGRERT_BOTILBUD("TTOFAGHOYUDINTBT"),
    HOYERE_YRKESFAGLIG_UTDANNING_SEMESTERAVGIFT("TTOFAGHOYUDSEMAV"),
    HOYERE_YRKESFAGLIG_UTDANNING_SKOLEPENGER("TTOFAGHOYUDSKOLP"),
    HOYERE_YRKESFAGLIG_UTDANNING_STUDIEREISE("TTOFAGHOYUDSTUDR"),

    FAG_OG_YRKESOPPLAERING_EKSAMENSGEBYR("TTOFOYEKSGEB"),
    FAG_OG_YRKESOPPLAERING_INTEGRERT_BOTILBUD("TTOFOYINTBOTIL"),
    FAG_OG_YRKESOPPLAERING_SEMESTERAVGIFT("TTOFOYSEMAVG"),
    FAG_OG_YRKESOPPLAERING_SKOLEPENGER("TTOFOYSKOLP"),
    FAG_OG_YRKESOPPLAERING_STUDIEREISE("TTOFOYSTUDREIS"),

    HOYERE_UTDANNING_EKSAMENSGEBYR("TTOHOYUDEKSGEB"),
    HOYERE_UTDANNING_INTEGRERT_BOTILBUD("TTOHOYUDINTBOTIL"),
    HOYERE_UTDANNING_SEMESTERAVGIFT("TTOHOYUDSEMAVG"),
    HOYERE_UTDANNING_SKOLEPENGER("TTOHOYUDSKOLP"),
    HOYERE_UTDANNING_STUDIEREISE("TTOHOYUDSTUDREIS"),

    NORSKOPPLAERING_GRUNNLEGGENDE_FERDIGHETER_FOV_EKSAMENSGEBYR("TTONOGFEKSGEB"),
    NORSKOPPLAERING_GRUNNLEGGENDE_FERDIGHETER_FOV_INTEGRERT_BOTILBUD("TTONOGFINTBOTIL"),
    NORSKOPPLAERING_GRUNNLEGGENDE_FERDIGHETER_FOV_SEMESTERAVGIFT("TTONOGFSEMAVG"),
    NORSKOPPLAERING_GRUNNLEGGENDE_FERDIGHETER_FOV_SKOLEPENGER("TTONOGFSKOLP"),
    NORSKOPPLAERING_GRUNNLEGGENDE_FERDIGHETER_FOV_STUDIEREISE("TTONOGFSTUDREIS"),

    STUDIESPESIALISERING_EKSAMENSGEBYR("TTOSTUDSPEKSGEB"),
    STUDIESPESIALISERING_INTEGRERT_BOTILBUD("TTOSTUDSPINTBT"),
    STUDIESPESIALISERING_SEMESTERAVGIFT("TTOSTUDSPSEMAVG"),
    STUDIESPESIALISERING_SKOLEPENGER("TTOSTUDSPSKOLP"),
    STUDIESPESIALISERING_STUDIEREISE("TTOSTUDSPSTUDRS"),

    ARBEIDSMARKEDSOPPLAERING_EKSAMENSGEBYR("TTOAAMOEKSGEB"),
    ARBEIDSMARKEDSOPPLAERING_INTEGRERT_BOTILBUD("TTOAAMOINTBOTIL"),
    ARBEIDSMARKEDSOPPLAERING_SEMESTERAVGIFT("TTOAAMOSEMAVG"),
    ARBEIDSMARKEDSOPPLAERING_SKOLEPENGER("TTOAAMOSKOLP"),
    ARBEIDSMARKEDSOPPLAERING_STUDIEREISE("TTOAAMOSTUDREIS");
}
