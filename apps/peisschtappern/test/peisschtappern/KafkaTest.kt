    ...
    private val testCases: List<TestCase> by lazy {
        Channel.all().map {
            when (it) {
                ...
                Channel.DryrunValp -> TestCase(it, TestRuntime.kafka.testTopic(it.topic))
                ...
                Channel.Valp -> TestCase(it, TestRuntime.kafka.testTopic(it.topic))
                Channel.ValpIntern -> TestCase(it, TestRuntime.kafka.testTopic(it.topic))
            }
        }
    }
