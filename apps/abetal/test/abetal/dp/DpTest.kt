...
internal class DpTest : ConsumerTestBase() {
    ...
    fun `simulation - dry run dp utbetaling`() {
        val utbet = JsonSerde.json.decodeFromString<DpUtbetaling>(
            """
            {
              "dryrun": false,
              "sakId": "rsid3",
        ...
        val dryrun = JsonSerde.json.decodeFromString<DpUtbetaling>(
            """
            {
              "dryrun": true,
              "sakId": "rsid3",
    ...
    fun `edge case - tombstone utbetaling then resend meldeperioder`() {
        ...
        val b = JsonSerde.json.decodeFromString<DpUtbetaling>(
        ...
        val c = JsonSerde.json.decodeFromString<DpUtbetaling>(
