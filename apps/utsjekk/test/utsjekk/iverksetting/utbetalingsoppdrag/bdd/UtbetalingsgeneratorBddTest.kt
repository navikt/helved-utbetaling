...
class UtbetalingsgeneratorBddTest {
    ...
    data class InputMedYtelse(
        ...
        private fun createStønadsdata(): Stønadsdata =
            when (ytelse) {
                is StønadTypeAAP -> StønadsdataAAP(stønadstype = ytelse, fastsattDagsats = 1000u)
                is StønadTypeDagpenger -> StønadsdataDagpenger(stønadstype = ytelse, meldekortId = "M1", fastsattDagsats = 1000u)
